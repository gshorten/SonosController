...
class VolumeControl:
    ...
    def __init__(self,enc_a,enc_b,s_unit):
        ...
        GPIO.add_event_detect(self.enc_a, GPIO.FALLING, callback=self.volume_set, bouncetime=50)  # Encoder A
        GPIO.add_event_detect(self.enc_b, GPIO.FALLING, callback=self.volume_set, bouncetime=50)  # Encoder B
